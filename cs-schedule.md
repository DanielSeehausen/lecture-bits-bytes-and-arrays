...
## Day 1
  - Introduction Lecture:
    ...
    - Pair or individual work
      ...
      - The Linked List should implement methods/variables for:
        - constructor
        - find(@value)
        - add(value)
        - delete(@value)
